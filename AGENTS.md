...
- references/ 字符预算：每个 ≤ 12,000 chars；v1.2.2 实际 12 个 reference，总 56,837 chars / 18,943 tokens（`token_budget.references_total` 上限 22,000；v1.2.1 加 yingxue-corpus.md 2001 chars/667 tokens）。
